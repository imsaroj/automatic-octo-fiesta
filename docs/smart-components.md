# Smart components — `@workspace/ui/smart-components/*`
...
## Buttons preset system — `@workspace/ui/smart-components/buttons`
...
## SmartPage slots — `@workspace/ui/smart-components/page`
