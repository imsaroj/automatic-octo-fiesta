...
function NotificationsSettings() {
  ...
  const items: { key: keyof typeof prefs; label: string; desc: string }[] = [
    ...
    { key: "browser_push", label: "Browser notifications", desc: "Push notifications in your browser." },
    { key: "mobile_push", label: "Mobile push", desc: "Push notifications on your phone." },
    { key: "product_updates", label: "Product updates", desc: "New features and improvements." },
    { key: "marketing", label: "Marketing emails", desc: "Promotions, offers, and announcements." },
    { key: "security_alerts", label: "Security alerts", desc: "Unusual sign-ins and security events." },
  ]
  ...
  return (
    <SmartPage layout="detail">
      ...
      <SmartPageTabs value={tab} onValueChange={setTab} variant="line">
        <SmartPageTab value="profile"><User className="size-3.5" />Profile</SmartPageTab>
        <SmartPageTab value="notifications"><Bell className="size-3.5" />Notifications</SmartPageTab>
        <SmartPageTab value="security"><Shield className="size-3.5" />Security</SmartPageTab>
        <SmartPageTab value="billing"><CreditCard className="size-3.5" />Billing</SmartPageTab>
        <SmartPageTab value="appearance"><Palette className="size-3.5" />Appearance</SmartPageTab>
        <SmartPageTab value="api"><Key className="size-3.5" />API</SmartPageTab>
        ...
        {["security", "billing", "appearance", "api"].map((v) => (
          <SmartPageTabPanel key={v} value={v}>
            <SmartPageContent padding="md">
              <p className="text-sm text-muted-foreground capitalize">{v} settings coming soon.</p>
            </SmartPageContent>
          </SmartPageTabPanel>
        ))}
      </SmartPageTabs>
